    ...
    const PageInspectorUI = {
        ...
        _renderTokenVaultAddForm() {
            ...
            area.innerHTML = `
                ...
                <div style="display:flex;gap:6px;">
                    <button id="ttd-pi-tokens-add-save" style="${Helpers._primaryBtnStyle()}">Save</button>
        ...
        _renderExport() {
            ...
            ['traffic', 'catalog', 'persistedTraffic', 'recorder', 'element', 'pageTiming', 'websocket', 'wsMessageCatalog', 'traceHistory', 'replay', 'replayHistory', 'sandboxRun', 'sandboxHistory', 'domSnapshot', 'eventDebugLog', 'domMutationLog', 'storageWatchLog', 'snapshots', 'tokenVault'].forEach((key) => {
